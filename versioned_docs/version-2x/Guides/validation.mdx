...
deep equal to compare reference types with [util.isDeepStrictEqual](https://nodejs.org/api/util.html#utilisdeepstrictequalval1-val2-options)
```gherkin
Then I expect '$variable' to deeply strictly equal '$js({ x: 42 })'
```
